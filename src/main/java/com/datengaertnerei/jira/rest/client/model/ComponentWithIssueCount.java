...
public class ComponentWithIssueCount {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(issueCount, description, self, project, projectId, assignee, lead, assigneeType, realAssignee, isAssigneeTypeValid, realAssigneeType, name, id);
  }
